label sceneMX:
    ...
    adamu "Putain qu'est-ce que j'ai hâte de la pulver Mami !" with hpunch
    adamu "Je veux juste la prendre en..."
    scene adamuRoom
    "{i}** Téléphone vibre **{/i}"
    play sound "audio/fx/notification.mp3" volume 0.3
    stop music
    scene msgMamiFinish with dissolve
    pause
    scene adamuRoom
    show adamuChillJoy with dissolve
    pause
    ...
    mami "Adamu, arrête de m'appeler comme ça s'il te plaît..."
    show adamuStun at right
    adamu "Euh... comment ça ?"
    ...
    mami "Bon je dois y aller, j'espère que tu trouveras quelqu'un de bien Adamu."
    mami "Salut !"
    scene frontSchool with dissolve
